...
void pickup_array18(int len , int* ary_in , int* ary_out1 , int* ary_out2);
void pickup_array13(int len , int* ary_in , int* ary_out1 , int* ary_out2);
void pickup_array116(int len , int* ary_in , int* ary_out1 , int* ary_out2);
void pickup_array15(int len , int* ary_in , int* ary_out1 , int* ary_out2);
void pickup_array132(int len , int* ary_in , int* ary_out1 , int* ary_out2);
void pickup_array19(int len , int* ary_in , int* ary_out1 , int* ary_out2);
...
void merge_array18(int len , int* ary_out , int* ary_in1 , int* ary_in2);
void merge_array13(int len , int* ary_out , int* ary_in1 , int* ary_in2);
void merge_array116(int len , int* ary_out , int* ary_in1 , int* ary_in2);
void merge_array15(int len , int* ary_out , int* ary_in1 , int* ary_in2);
void merge_array132(int len , int* ary_out , int* ary_in1 , int* ary_in2);
void merge_array19(int len , int* ary_out , int* ary_in1 , int* ary_in2);
...
int main()
{
  ...
  /////////////////layer 4///////////////////
  ////////////////for dsp//////////////////
  pickup_array18(len , &ary[0] , &ary_half1[0] , &ary_half2[0]);
  printf("layer%2d : ",l_number);
  l_number++;
  print_array(ary_p , len);
  printf("half  1 : ");
  ...
  merge_array18(len , &ary[0] , &ary_half1[0] , &ary_half2[0]);
  ...
  /////////////////layer 7///////////////////
  ////////////////for dsp//////////////////
  pickup_array116(len , &ary[0] , &ary_half1[0] , &ary_half2[0]);
  printf("layer%2d : ",l_number);
  l_number++;
  print_array(ary_p , len);
  printf("half  1 : ");
  ...
  merge_array116(len , &ary[0] , &ary_half1[0] , &ary_half2[0]);
  ...
  /////////////////layer 11///////////////////
  ////////////////for dsp//////////////////
  pickup_array132(len , &ary[0] , &ary_half1[0] , &ary_half2[0]);
  printf("layer%2d : ",l_number);
  l_number++;
  print_array(ary_p , len);
  printf("half  1 : ");
  ...
  merge_array132(len , &ary[0] , &ary_half1[0] , &ary_half2[0]);

  /////////////////layer 12///////////////////
  ////////////////for dsp//////////////////
  pickup_array19(len , &ary[0] , &ary_half1[0] , &ary_half2[0]);
  printf("layer%2d : ",l_number);
  l_number++;
  print_array(ary_p , len);
  printf("half  1 : ");
  ...
  merge_array19(len , &ary[0] , &ary_half1[0] , &ary_half2[0]);
...
void pickup_array132(int len , int* ary_in , int* ary_out1 , int* ary_out2)
{
  ...
  for(i = 0; i < len; i++) {
    ...
    if(((j+1)%16)==0){ //8 element finished -> move next 8 element
      i+=16;
      k+=48;
    }
    k--;
